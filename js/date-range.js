...
(function () {
  ...
  class DataRange {
    ...
    render() {
      ...
      LANGS.map(this.getDateElement.bind(this)).forEach((element) => this.element.appendChild(element));
  ...
  /** @param {Element} element */
  const buildDataRange = (element) => new DataRange(element.getAttribute("data-date-start"), element.getAttribute("data-date-end"), element);
